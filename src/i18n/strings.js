...
export const STRINGS = {
  pt: {
    ...
    onboarding: {
      welcome:      'Olá, aventureiro!',
      askName:      'Como te chamas?',
      placeholder:  'Escreve o teu nome aqui',
      hint:         'Entre 2 e 20 letras. Vais aparecer no ranking!',
      checking:     'A verificar...',
      available:    '✅ Esse nome está disponível!',
      taken:        '❌ Esse nome já está em uso. Tenta outro!',
      tooShort:     'Demasiado curto (mínimo 2 letras)',
      tooLong:      'Demasiado comprido (máximo 20)',
      invalidChars: 'Usa só letras, números, espaços, pontos, hífens.',
      start:        'Começar a aventura!',
      creating:     'A criar a tua conta...',
      errorGeneric: 'Algo correu mal. Tenta de novo.',
    },
    recovery: {
      celebrationTitle: 'Bem-vindo, {nickname}!',
      cofrinhoSays:     'Eu sou o Cofrinho! Guarda bem este código secreto:',
      whatIsThis:       'Com ele consegues continuar a tua aventura noutro tablet ou se apagares a cache!',
