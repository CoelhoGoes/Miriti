...
export const STRINGS = {
  pt: {
    ...
    arcade: {
      ...
      homeDesc: '15 ações • 1 000 moedas iniciais • Gestão de recursos',
      homeCta: 'Entrar no Arcade',
      homeBack: 'Modo História',
      startTitle: 'Pronto para o desafio?',
      startDesc: 'Você começa com 1 000 moedas e tem 15 ações. Use-as na Escola, Feira e Cooperativa para maximizar seu saldo.',
      ...
      lbTitle: 'Ranking do Arcade',
      lbCta: 'Ver ranking',
      lbLoading: 'Carregando ranking...',
      lbEmpty: 'Seja o primeiro no ranking! 🏆',
      lbError: 'Não deu pra carregar o ranking agora.',
      lbRetry: 'Tentar de novo',
      lbOffline: 'Ranking indisponível offline. Volte quando tiver internet!',
      lbYou: '(você)',
      lbBack: 'Voltar',
      ...
      quizLimitReached: 'Limite de quiz atingido!',
      quizCooldown: 'Faça outra coisa antes do próximo quiz!',
    },
  },
  ...
  en: {
    ...
    arcade: {
      ...
      homeDesc: '15 actions • 1,000 starting coins • Resource management',
      homeCta: 'Enter Arcade',
      homeBack: 'Story Mode',
      startTitle: 'Ready for the challenge?',
      startDesc: 'You start with 1,000 coins and have 15 actions. Use them at the School, Market and Cooperative to maximise your balance.',
      startCta: 'Start now!',
      ...
      lbTitle: 'Arcade Leaderboard',
      lbCta: 'View leaderboard',
      lbLoading: 'Loading leaderboard...',
      lbEmpty: 'Be the first on the leaderboard! 🏆',
      lbError: 'Could not load the leaderboard right now.',
      lbRetry: 'Try again',
      lbOffline: 'Leaderboard unavailable offline. Come back when you are online!',
      lbYou: '(you)',
      lbBack: 'Back',
      ...
      quizCooldown: 'Do something else before the next quiz!',
    },
  }
}
