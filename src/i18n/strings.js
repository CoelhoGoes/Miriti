...
export const STRINGS = {
  pt: {
    ...
    rotateDevice: {
      ...
      message:  'Por favor, rode o teu dispositivo para o lado para começar a aventura!',
    },
    a11y: {
    ...
    feirinha: {
      ...
      sellModal: {
        ...
        youHave:        'Tens {n} unidade(s)',
        sellOne:        'Vender 1',
        sellAll:        'Vender tudo ({n})',
        close:          'Fechar',
        cooldownActive: '⏳ Aguarda {n} ronda(s) para vender',
        totalGain:      'Ganhas {n} 🪙',
      },
      barometer: {
        level1: 'Muito barato!',
      ...
      cofrinhoTip: {
        ...
        tipBlueZone:       'Quando o termómetro está azul ❄️, é hora de comprar barato!',
        tipRedZone:        'Quando o termómetro está vermelho 🔥, é hora de vender caro!',
        tipBalance:        'Equilibre suas compras: nem tudo num só produto!',
        tipBasketLow:      'A tua cesta está vazia! Aproveita os preços baratos.',
        tipBasketFull:     'Tens muitos produtos! Considera vender alguns.',
        tipRotateA:        'Compra barato, vende caro: é a regra de ouro do mercado!',
        tipRotateB:        'Cada produto tem seu ritmo. Observa antes de decidir!',
        tipRotateC:        'Dinheiro guardado também é dinheiro: nem sempre é hora de comprar.',
        tipPriceReference: 'O preço normal é quanto o produto costuma valer. Compara sempre com o preço agora!',
      },
      legend: {
        title:     'Como ler o termómetro:',
        cheap:     'Barato',
        normal:    'Normal',
        expensive: 'Caro',
      },
      ...
      priceHistory: {
        ...
        noHistory:   'Sem histórico ainda — joga mais rondas!',
        close:       'Fechar',
    ...
    deactivate: {
      ...
      buttonLabel:     'Inativar a minha conta',
      modalTitle:      'Vais ficar invisível?',
      cofrinhoSays:    'A tua conta vai sumir do ranking, mas o teu progresso fica guardado!',
      whatHappens:     'O que acontece:',
      bullet1:         '🙈 Não apareces no ranking',
      bullet2:         '💾 O teu progresso fica seguro',
      bullet3:         '🔑 Podes voltar com o teu código secreto',
      yourCode:        'O teu código:',
      copyCode:        'Copiar código',
      copied:          '✅ Copiado!',
      confirmCheckbox: 'Eu copiei o meu código secreto',
      ...
      processing:      'A inativar...',
      success:         '✅ Conta inativada. Volta sempre!',
      errorGeneric:    'Algo correu mal. Tenta de novo.',
    },
    deleteAccount: {
      sectionTitle:    'Apagar conta para sempre',
      buttonLabel:     'Apagar a minha conta',
      modalTitle:      '⚠️ Apagar para SEMPRE?',
      cofrinhoSays:    'Esta acção não tem volta! Vais perder TUDO!',
      whatHappens:     'O que se vai perder:',
      bullet1:         '🗑️ O teu progresso e moedas',
      bullet2:         '🏆 A tua posição no ranking',
      bullet3:         '🔑 O teu código secreto deixa de funcionar',
      typeToConfirm:   'Para confirmar, escreve {keyword} aqui:',
      typeKeyword:     'APAGAR',
      placeholderType: 'Escreve aqui...',
      confirmCheckbox: 'Eu entendo que esta acção é irreversível',
      cancel:          'Cancelar',
      confirm:         'Apagar para sempre',
      processing:      'A apagar...',
      success:         'Conta apagada. Adeus! 👋',
      errorGeneric:    'Algo correu mal. Tenta de novo.',
    },
  },
